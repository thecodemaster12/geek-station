<?php
    ...
    if (isset($_SESSION['user'])) {
        $userInfo = getUserInfo($_SESSION['user'], $conn);
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="user-admin-post.php" class=" waves-effect">
                            ...
                            <li>
                                <a href="user-tech-post.php" class=" waves-effect">
                            ...
                            <li>
                                <a href="user-coding-post.php" class=" waves-effect">
                            ...
                            <li>
                                <a href="user-game-post.php" class=" waves-effect">
                        ...
                        <!-- Left Menu Guideline -->
                        <ul class="metismenu list-unstyled" id="side-menu">
                            <li class="menu-title">Guideline</li>

                            <li>
                                <a href="rules.php" class="waves-effect">
                                    <i class="ri-file-list-3-line"></i><span class="badge rounded-pill bg-success float-end">3</span>
                                    <span>Rules</span>
                                </a>
                            </li>
