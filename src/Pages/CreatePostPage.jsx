...
const CreatePostPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
      <h1 className="text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Create New Blog Post</h1>
      ...
      <div className="mt-10 p-4 bg-gray-50 rounded-lg border border-dashed border-gray-300">
        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Editor Output Preview (HTML):</h2>
        <div className="text-xs font-mono text-gray-600 break-all overflow-auto max-h-40 p-2 bg-white rounded border border-gray-200">
          {content || 'Wait for it...'}
        </div>
      </div>
    </div>
