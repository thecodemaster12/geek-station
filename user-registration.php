                    ...
                    <div class="card-body">
                        ...
                        <?php
                            if (isset($_SESSION['reg-error'])) {
                                echo "
                                    <div class='alert alert-danger alert-dismissible fade show mb-0 mt-4 text-center' role='alert'>
                                        ".$_SESSION['reg-error']."
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="post" action="includes/reg-handel.php">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" name="userPass" type="password" placeholder="Password">
                                    </div>
                                </div>

                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" name="conPass" type="password" placeholder="Confirm Password">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mt-2 mb-0 row">
                                    <div class="col-12 mt-3 text-center">
                                        <a href="user-login.php" class="text-muted">Already have account?</a>
                                    </div>
                                </div>
                            </form>
                            <!-- end form -->
